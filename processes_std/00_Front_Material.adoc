...
|`2019.10.11` |0.2 | Dimitri Sarafinof| first draft with generic processes description
|`2020.01.28` |0.3 | Dimitri Sarafinof| second draft with generic processes description (with feedback from Tallinn meeting) 
!===
